...
def create_config(debug=True):
    ...
    # =====================================================================
        ...
        base_config.update({
            ...
            # 采样 & 载荷 (Phase-1) - 更密集
            # ================================================================
            "n_domain": 4000,          # 域内采样点数
            "n_bc": 200,               # 边界采样点数
            "max_displacement": 0.0012, # 最大位移载荷
            "n_loading_steps": 40,     # 载荷步数

            # ================================================================
            # notch 初始化 (Phase-1)
            # ================================================================
            "notch_seed_radius": 0.0025, # 高斯核半径
            "initial_d": 0.8,         # 初始损伤峰值
            "notch_init_epochs": 1200, # notch 预训练 epoch
